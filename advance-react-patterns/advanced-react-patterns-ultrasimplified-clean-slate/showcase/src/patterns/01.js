...
const initialState = { count: 0, countTotal: 265, isClicked: false };

/*
 * Higher Order component
 */

const wihtClapAnimation = (WrappedComponent) => {
  class WithClapAnimation extends Component {
    ...
    componentDidMount() {
      ...
      const trianguleBurst = new mojs.Burst({
        parent: '#clap',
        radius: { 50: 95 },
        count: 5,
        angle: 30,
      ...
      const newAniamtionTimeline = this.animationTimeline.add([
        scaleButton,
        countTotalAnimation,
        countAnimation,
        trianguleBurst,
      ...
      this.setState({ animationTimeline: newAniamtionTimeline });
    }
...
const Usage = () => {
  const AnimatedMediumClap = wihtClapAnimation(MediumClap);
