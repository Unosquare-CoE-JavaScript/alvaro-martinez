...
const INITIAL_STATE = { count: 0, countTotal: 265, isClicked: false };
...
const useClapAnimation = ({ clapEl, countEl, totalEl }) => {
  ...
  useLayoutEffect(() => {
    ...
    const newAniamtionTimeline = animationTimeline.add([
      scaleButton,
      countTotalAnimation,
      countAnimation,
      trianguleBurst,
    ...
    setAnimationTimeline(newAniamtionTimeline);
...
const userInitialState = { count: 20, countTotal: 500, isClicked: true };
